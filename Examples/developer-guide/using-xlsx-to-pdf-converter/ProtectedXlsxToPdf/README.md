...
This example demonstrates how to convert password-protected xlsx to pdf using GroupDocs.Conversion.LowCode.

## Overview

This console application shows how to convert password-protected xlsx to pdf.

## Purpose

This example demonstrates the **protected xlsx to pdf workflow**:
- Convert password-protected XLSX to PDF
