...
This example demonstrates how to convert xlsx to password-protected pdf using GroupDocs.Conversion.LowCode.

## Overview

This console application shows how to convert xlsx to password-protected pdf.

## Purpose

This example demonstrates the **xlsx to password protected pdf workflow**:
