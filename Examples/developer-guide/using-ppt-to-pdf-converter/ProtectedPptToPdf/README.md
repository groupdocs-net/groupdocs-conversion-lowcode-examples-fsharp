...
This example demonstrates how to convert password-protected ppt to pdf using GroupDocs.Conversion.LowCode.

## Overview

This console application shows how to convert password-protected ppt to pdf.

## Purpose

This example demonstrates the **protected ppt to pdf workflow**:
- Convert password-protected PPT to PDF
