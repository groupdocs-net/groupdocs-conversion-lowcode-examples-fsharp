...
This example demonstrates how to convert ppt to password-protected pdf using GroupDocs.Conversion.LowCode.

## Overview

This console application shows how to convert ppt to password-protected pdf.

## Purpose

This example demonstrates the **ppt to password protected pdf workflow**:
