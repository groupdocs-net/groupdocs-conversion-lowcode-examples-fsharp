...
This example demonstrates how to convert password-protected pdf to docx using GroupDocs.Conversion.LowCode.

## Overview

This console application shows how to convert password-protected pdf to docx.

## Purpose

This example demonstrates the **protected pdf to docx workflow**:
- Convert password-protected PDF to DOCX
