...
This example demonstrates how to convert pdf with flattened form fields to docx using GroupDocs.Conversion.LowCode.

## Overview

This console application shows how to convert pdf with flattened form fields to docx.

## Purpose

This example demonstrates the **flatten fields in form fillable pdf workflow**:
- Convert PDF with flattened form fields to DOCX
