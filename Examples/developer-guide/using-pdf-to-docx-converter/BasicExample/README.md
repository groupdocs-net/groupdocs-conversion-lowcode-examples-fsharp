# PDF to DOCX - Basic Example

This example demonstrates how to basic pdf to docx conversion using GroupDocs.Conversion.LowCode.

## Overview

This console application shows how to basic pdf to docx conversion.

## Purpose

This example demonstrates the **pdf to docx - basic example workflow**:
