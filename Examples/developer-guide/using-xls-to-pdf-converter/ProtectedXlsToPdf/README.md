...
This example demonstrates how to convert password-protected xls to pdf using GroupDocs.Conversion.LowCode.

## Overview

This console application shows how to convert password-protected xls to pdf.

## Purpose

This example demonstrates the **protected xls to pdf workflow**:
- Convert password-protected XLS to PDF
