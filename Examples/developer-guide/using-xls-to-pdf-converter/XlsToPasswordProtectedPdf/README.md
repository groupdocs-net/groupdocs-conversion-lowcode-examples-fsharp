...
This example demonstrates how to convert xls to password-protected pdf using GroupDocs.Conversion.LowCode.

## Overview

This console application shows how to convert xls to password-protected pdf.

## Purpose

This example demonstrates the **xls to password protected pdf workflow**:
