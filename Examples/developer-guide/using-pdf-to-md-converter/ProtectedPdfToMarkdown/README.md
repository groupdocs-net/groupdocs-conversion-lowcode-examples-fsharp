...
This example demonstrates how to convert password-protected pdf to markdown using GroupDocs.Conversion.LowCode.

## Overview

This console application shows how to convert password-protected pdf to markdown.

## Purpose

This example demonstrates the **protected pdf to markdown workflow**:
