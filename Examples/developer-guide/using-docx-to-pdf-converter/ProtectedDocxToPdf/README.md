...
This example demonstrates how to convert password-protected docx to pdf using GroupDocs.Conversion.LowCode.

## Overview

This console application shows how to convert password-protected docx to pdf.

## Purpose

This example demonstrates the **protected docx to pdf workflow**:
