...
This example demonstrates how to convert docx to password-protected pdf using GroupDocs.Conversion.LowCode.

## Overview

This console application shows how to convert docx to password-protected pdf.

## Purpose

This example demonstrates the **docx to password protected pdf workflow**:
