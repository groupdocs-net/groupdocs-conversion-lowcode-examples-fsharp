...
This example demonstrates how to convert html to pdf with specific zoom level using GroupDocs.Conversion.LowCode.

## Overview

This console application shows how to convert html to pdf with specific zoom level.

## Purpose

This example demonstrates the **html with zoom level workflow**:
- Convert HTML to PDF with specific zoom level
