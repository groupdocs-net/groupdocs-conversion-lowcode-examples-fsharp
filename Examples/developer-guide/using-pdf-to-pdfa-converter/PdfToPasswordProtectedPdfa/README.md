...
This example demonstrates how to convert pdf to password-protected pdf/a using GroupDocs.Conversion.LowCode.

## Overview

This console application shows how to convert pdf to password-protected pdf/a.

## Purpose

This example demonstrates the **pdf to password protected pdf/a workflow**:
