# Protected DOC to PDF

This example demonstrates how to convert password-protected doc to pdf using GroupDocs.Conversion.LowCode.

## Overview

This console application shows how to convert password-protected doc to pdf.

## Purpose

This example demonstrates the **protected doc to pdf workflow**:
